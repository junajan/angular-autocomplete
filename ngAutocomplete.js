...
angular.module("ngAutocomplete", ["ng"])
 .directive("autocomplete", ["$compile", "$timeout", "$document", function ($compile, $timeout, $document) {
    return {
        restrict: 'E',
        replace: true,
        scope: {
        ...
        template: "<span class='livesearch'><input type='text' ng-blur='blurInput()' /></span>",
